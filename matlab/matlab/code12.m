...
subplot(3,1,1)
plot(y(1,:),y(2,:),'Color','b','Marker','x','MarkerSize',3)
ylabel('state')
xlabel('time')
hold all
subplot(3,1,2)
plot(y(1,:),y(3,:),'Color','b','Marker','x','MarkerSize',3)
ylabel('adjoint')
xlabel('time')
hold all
subplot(3,1,3)
plot(y(1,:),y(4,:),'Color','b','Marker','x','MarkerSize',3)
ylabel('control')
xlabel('time')
hold all